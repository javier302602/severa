...
import type { GraficosOutputPort } from '../../../src/application/ports/out/graphics/GraficosOutputPort';
...
jest.mock('../../../src/infrastructure/config/container', () => {
  const { CalcularResumenEstadistico } = require('../../../src/application/usecases/module_medidas_tendencia_dispersion/CalcularResumenEstadistico');
  const { GenerarDistribucionFrecuencias } = require('../../../src/application/usecases/module_distribucion_frecuencias/GenerarDistribucionFrecuencias');
  const { GenerarGrafico } = require('../../../src/application/usecases/module_visualizacion_grafica/GenerarGrafico');
